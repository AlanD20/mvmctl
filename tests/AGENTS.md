...
**Files:** 161 test files (118 unit + 18 integration + 18 system + 7 layer_compliance)
...
├── unit/                    # 118 unit test files across all modules
├── integration/
│   ├── conftest.py          # Integration-specific fixtures
│   └── test_*.py            # Multi-module workflow tests (18 files)
├── system/
│   ├── conftest.py          # Real hardware fixtures; _restore_real_dirs override
│   └── test_*.py            # Black-box CLI tests via subprocess (18 files)
├── layer_compliance/
...
- **161 total test files**: 118 unit + 18 integration + 18 system + 7 layer_compliance
