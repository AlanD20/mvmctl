...
from fcm.utils.audit import _audit_logger, _get_audit_log_path, log_audit
...
class TestGetAuditLogPath:
    ...
    def test_returns_cache_dir_path(self, tmp_path):
        ...
        with patch("fcm.utils.audit.get_cache_dir", return_value=tmp_path):
...
class TestAuditLogger:
    ...
    def test_returns_same_logger_instance(self, tmp_path):
        ...
        with patch("fcm.utils.audit.get_cache_dir", return_value=tmp_path):
            ...
            logger = logging.getLogger("fcm.audit")
            logger.handlers = []
    ...
    def test_creates_directory_if_not_exists(self, tmp_path):
        ...
        with patch("fcm.utils.audit.get_cache_dir", return_value=cache_dir):
            # Clear any existing handlers
            logger = logging.getLogger("fcm.audit")
            logger.handlers = []
...
class TestLogAudit:
    ...
    @patch("fcm.utils.audit._audit_logger")
