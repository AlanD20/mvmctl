...
var codeClassMap = map[Code]Class{
	...
	CodeVMCgroupVerificationFailed: ClassInternal,
	CodeVMCgroupCleanupFailed:      ClassInternal,
	...
	CodeBinaryPairInvalid:          ClassValidation,
	CodeBinaryUntrusted:            ClassValidation,
	CodeBinaryTrustedInstallFailed: ClassInternal,
...
var codeOpMap = map[Code]string{
	...
	CodeVMCgroupVerificationFailed: "vm",
	CodeVMCgroupCleanupFailed:      "vm",
	...
	CodeBinaryPairInvalid:          "binary",
	CodeBinaryUntrusted:            "binary",
	CodeBinaryTrustedInstallFailed: "binary",
