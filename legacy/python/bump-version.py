...
def update_root_changelog(root: Path, new_version: str, dry_run: bool, changelog_content: str = "") -> None:
    ...
    # Still need to find section boundaries for proper file reconstruction.
