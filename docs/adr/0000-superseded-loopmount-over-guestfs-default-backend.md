# 0000 — Loopmount over Guestfs as Default Provisioning Backend (superseded)

**Status:** superseded by ADR-0006 (loopmount-guestfs-mutual-exclusion)
**Original number:** ADR-0006 (renumbered to 0000 on collision resolution)
