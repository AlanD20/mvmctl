...
def _db_state_to_vm_instance(db_vm: DBVMInstance) -> VMInstance:
    ...
    return VMInstance(
        ...
        console_socket_path=Path(db_vm.console_socket_path) if db_vm.console_socket_path else None,
        config=config,
        nocloud_net_port=db_vm.nocloud_net_port,
        nocloud_server_pid=db_vm.nocloud_server_pid,
        console_relay_pid=db_vm.console_relay_pid,
