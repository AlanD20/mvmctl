...
type MockSnapshotAPI struct {
	...
	SnapshotInspectFunc func(ctx context.Context, input inputs.SnapshotInput) (*model.SnapshotItem, error)
...
func (m *MockSnapshotAPI) SnapshotInspect(ctx context.Context, input inputs.SnapshotInput) (*model.SnapshotItem, error) {
...
func (m *MockSnapshotAPI) SnapshotRestore(ctx context.Context, input inputs.SnapshotRestoreInput) ([]*model.VMItem, error) {
