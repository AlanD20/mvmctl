...
// versionCleanPattern captures the leading numeric version from strings like
// "1.15.1-dev" or "1.15.1", matching "^(\d+(?:\.\d+)*)" un-anchored.
...
// - "firecracker:" → ("firecracker", "")
//
// Returns empty string for name when no prefix was found.
